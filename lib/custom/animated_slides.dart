  ...
  List slideList = [
    {
      ...
      "img": AssetImage('images/addition_background.jpg'),
    }, 
    {
      "title": "Subtraction",
      "icon": FontAwesomeIcons.minus,
      "img": AssetImage('images/subtraction_background.jpg'),
    }, 
    {
      "title": "Multiplication",
      "icon": FontAwesomeIcons.times,
      "img": AssetImage('images/multiply_background.jpg'),
    }, 
    {
      "title": "Division",
      "icon": FontAwesomeIcons.divide,
      "img": AssetImage('images/divide_background.jpg'),
    }, 
    {
      "title": "Custom",
      "icon": FontAwesomeIcons.question,
      "img": AssetImage('images/all_background.png'),
    },                 
  ];
